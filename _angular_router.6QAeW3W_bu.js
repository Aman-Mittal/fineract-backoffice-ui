import { a as l, b as N, e as S } from "@nf-internal/chunk-IQO3VMP7";
import { DOCUMENT as qn, Location as Xt } from "@angular/common";
import * as R from "@angular/core";
import { \u0275isPromise as Bn, \u0275RuntimeError as M, computed as Vn, InjectionToken as ee, EventEmitter as Ye, input as Gn, inject as g, ViewContainerRef as Wn, ChangeDetectorRef as Qn, reflectComponentType as Kn, runInInjectionContext as $, \u0275isInjectable as Yn, \u0275isNgModule as Ka, isStandalone as Ya, createEnvironmentInjector as Zn, Compiler as Jn, \u0275maybeUnwrapDefaultExport as Mr, NgModuleFactory as Xn, afterNextRender as ei, signal as Cr, EnvironmentInjector as er, DestroyRef as ti, untracked as Ue, \u0275Console as ri, \u0275PendingTasksInternal as ni, \u0275INTERNAL_APPLICATION_ERROR_HANDLER as ii, \u0275formatRuntimeError as oi } from "@angular/core";
import { isObservable as Dr, from as W, of as m, BehaviorSubject as F, combineLatest as _r, EmptyError as ai, Observable as si, concat as ci, defer as tr, pipe as ui, EMPTY as z, throwError as li, Subject as Lt, Subscription as hi } from "rxjs";
import { first as fe, map as U, switchMap as H, take as Le, startWith as di, filter as je, takeUntil as jt, mergeMap as le, concatMap as Ur, tap as G, takeLast as Or, catchError as Pr, finalize as fi } from "rxjs/operators";
import * as Lr from "@angular/platform-browser";
...
function pi(t, n) { if (t.length !== n.length)
...
function xr(t, n) { if (Array.isArray(t) && Array.isArray(n)) {
    ...
    return t === n; }
function gi(t) { return t.length > 0 ? t[t.length - 1] : null; }
function pe(t) { return Dr(t) ? t : Bn(t) ? W(Promise.resolve(t)) : m(t); }
function kr(t) { return Dr(t) ? rt(t) : Promise.resolve(t); }
var vi = { exact: zr, subset: Hr }, $r = { exact: mi, subset: yi, ignored: () => !0 }, rr = { paths: "exact", fragment: "ignored", matrixParams: "ignored", queryParams: "exact" }, xe = { paths: "subset", fragment: "ignored", matrixParams: "ignored", queryParams: "subset" };
function nr(t, n, e) { let r = t instanceof _ ? t : n.parseUrl(t); return Vn(() => $t(n.lastSuccessfulNavigation()?.finalUrl ?? new _, r, l(l({}, xe), e))); }
function $t(t, n, e) { return vi[e.paths](t.root, n.root, e.matrixParams) && $r[e.queryParams](t.queryParams, n.queryParams) && !(e.fragment === "exact" && t.fragment !== n.fragment); }
function mi(t, n) { return Q(t, n); }
function zr(t, n, e) { if (!ue(t.segments, n.segments) || !Xe(t.segments, n.segments, e) || t.numberOfChildren !== n.numberOfChildren)
    return !1; for (let r in n.children)
    if (!t.children[r] || !zr(t.children[r], n.children[r], e))
        return !1; return !0; }
function yi(t, n) { return Object.keys(n).length <= Object.keys(t).length && Object.keys(n).every(e => xr(t[e], n[e])); }
function Hr(t, n, e) { return Fr(t, n, n.segments, e); }
function Fr(t, n, e, r) { if (t.segments.length > e.length) {
    ...
    for (let i in n.children)
        if (!t.children[i] || !Hr(t.children[i], n.children[i], r))
            return !1;
    return !0;
}
else {
    let i = e.slice(0, t.segments.length), o = e.slice(t.segments.length);
    return !ue(t.segments, i) || !Xe(t.segments, i, r) || !t.children[f] ? !1 : Fr(t.children[f], n, o, r);
} }
function Xe(t, n, e) { return n.every((r, i) => $r[e](t[i].parameters, r.parameters)); }
var _ = class {
    root;
    queryParams;
    fragment;
    ...
    toString() { return Ci.serialize(this); }
}, y = class {
    segments;
    children;
    parent = null;
    ...
    toString() { return Br(this); }
};
function Ri(t, n) { return ue(t, n) && t.every((e, r) => Q(e.parameters, n[r].parameters)); }
function ue(t, n) { return t.length !== n.length ? !1 : t.every((e, r) => e.path === n[r].path); }
function Si(t, n) { let e = []; return Object.entries(t.children).forEach(([r, i]) => { r === f && (e = e.concat(n(i, r))); }), Object.entries(t.children).forEach(([r, i]) => { r !== f && (e = e.concat(n(i, r))); }), e; }
var ae = (() => { class t {
    ...
    serialize(n) { let e = `/${De(n.root, !0)}`, r = Ii(n.queryParams), i = typeof n.fragment == "string" ? `#${wi(n.fragment)}` : ""; return `${e}${r}${i}`; }
}, Ci = new J;
function et(t) { return t.segments.map(n => Br(n)).join("/"); }
function De(t, n) { if (!t.hasChildren())
    ...
    let e = Si(t, (r, i) => i === f ? [De(t.children[f], !1)] : [`${i}:${De(r, !1)}`]);
    return Object.keys(t.children).length === 1 && t.children[f] != null ? `${et(t)}/${e[0]}` : `${et(t)}/(${e.join("//")})`;
} }
function qr(t) { return encodeURIComponent(t).replace(/%40/g, "@").replace(/%3A/gi, ":").replace(/%24/g, "$").replace(/%2C/gi, ","); }
function Ze(t) { return qr(t).replace(/%3B/gi, ";"); }
function wi(t) { return encodeURI(t); }
function zt(t) { return qr(t).replace(/\(/g, "%28").replace(/\)/g, "%29").replace(/%26/gi, "&"); }
function tt(t) { return decodeURIComponent(t); }
function wr(t) { return tt(t.replace(/\+/g, "%20")); }
function Br(t) { return `${zt(t.path)}${bi(t.parameters)}`; }
function bi(t) { return Object.entries(t).map(([n, e]) => `;${zt(n)}=${zt(e)}`).join(""); }
function Ii(t) { let n = Object.entries(t).map(([e, r]) => Array.isArray(r) ? r.map(i => `${Ze(e)}=${Ze(i)}`).join("&") : `${Ze(e)}=${Ze(r)}`).filter(e => e); return n.length ? `?${n.join("&")}` : ""; }
var Ai = /^[^\/()?;#]+/;
function Ut(t) { let n = t.match(Ai); return n ? n[0] : ""; }
var Ei = /^[^\/()?;=#]+/;
function Ti(t) { let n = t.match(Ei); return n ? n[0] : ""; }
var Ni = /^[^=?&#]+/;
function Mi(t) { let n = t.match(Ni); return n ? n[0] : ""; }
var Di = /^[^&#]+/;
function _i(t) { let n = t.match(Di); return n ? n[0] : ""; }
var Ht = class {
    url;
    remaining;
    ...
    parseParam(n) { let e = Ti(this.remaining); if (!e)
        return; this.capture(e); let r = ""; if (this.consumeOptional("=")) {
        let i = Ut(this.remaining);
        i && (r = i, this.capture(r));
    } n[tt(e)] = tt(r); }
    parseQueryParam(n) { let e = Mi(this.remaining); if (!e)
        return; this.capture(e); let r = ""; if (this.consumeOptional("=")) {
        let a = _i(this.remaining);
        a && (r = a, this.capture(r));
    } let i = wr(e), o = wr(r); if (Object.hasOwn(n, i)) {
        let a = n[i];
...
function Vr(t) { return t.segments.length > 0 ? new y([], { [f]: t }) : t; }
function Gr(t) { let n = Object.create(null); for (let [r, i] of Object.entries(t.children)) {
    let o = Gr(i);
...
} let e = new y(t.segments, n); return Ui(e); }
function Ui(t) { if (t.numberOfChildren === 1 && t.children[f]) {
    let n = t.children[f];
    return new y(t.segments.concat(n.segments), n.children);
} return t; }
function ie(t) { return t instanceof _; }
function Wr(t, n, e = null, r = null, i = new J) { let o = Qr(t); return Kr(o, n, e, r, i); }
function Qr(t) { let n; function e(o) { let a = {}; for (let s of o.children) {
    let u = e(s);
    a[s.outlet] = u;
} let c = new y(o.url, a); return o === t && (n = c), c; } let r = e(t.root), i = Vr(r); return n ?? i; }
function Kr(t, n, e, r, i) { let o = t; for (; o.parent;)
    o = o.parent; if (n.length === 0)
    return Ot(o, o, o, e, r, i); let a = Oi(n); if (a.toRoot())
    return Ot(o, o, new y([], {}), e, r, i); let c = Pi(a, o, t), s = c.processChildren ? Oe(c.segmentGroup, c.index, a.commands) : Zr(c.segmentGroup, c.index, a.commands); return Ot(o, c.segmentGroup, s, e, r, i); }
function nt(t) { return typeof t == "object" && t != null && !t.outlets && !t.segmentPath; }
function ke(t) { return typeof t == "object" && t != null && t.outlets; }
function br(t, n, e) { t ||= "\u0275"; let r = new _; return r.queryParams = { [t]: n }, e.parse(e.serialize(r)).queryParams[t]; }
function Ot(t, n, e, r, i, o) { let a = {}; for (let [u, h] of Object.entries(r ?? {}))
    a[u] = Array.isArray(h) ? h.map(v => br(u, v, o)) : br(u, h, o); let c; t === n ? c = e : c = Yr(t, n, e); let s = Vr(Gr(c)); return new _(s, a, i); }
function Yr(t, n, e) { let r = Object.create(null); return Object.entries(t.children).forEach(([i, o]) => { o === n ? r[i] = e : r[i] = Yr(o, n, e); }), new y(t.segments, r); }
var it = class {
    isAbsolute;
    numberOfDoubleDots;
    commands;
    constructor(n, e, r) { if (this.isAbsolute = n, this.numberOfDoubleDots = e, this.commands = r, n && r.length > 0 && nt(r[0]))
        throw new M(4003, !1); let i = r.find(ke); if (i && i !== gi(r))
        throw new M(4004, !1); }
    toRoot() { return this.isAbsolute && this.commands.length === 1 && this.commands[0] == "/"; }
};
function Oi(t) { if (typeof t[0] == "string" && t.length === 1 && t[0] === "/")
...
function Pi(t, n, e) { if (t.isAbsolute)
    ...
    return new ye(e, !0, 0); let r = nt(t.commands[0]) ? 0 : 1, i = e.segments.length - 1 + r; return Li(e, i, t.numberOfDoubleDots); }
function Li(t, n, e) { let r = t, i = n, o = e; for (; o > i;) {
    if (o -= i, r = r.parent, !r)
        throw new M(4005, !1);
    i = r.segments.length;
} return new ye(r, !1, i - o); }
function ji(t) { return ke(t[0]) ? t[0].outlets : { [f]: t }; }
function Zr(t, n, e) { if (t ??= new y([], {}), t.segments.length === 0 && t.hasChildren())
    return Oe(t, n, e); let r = xi(t, n, e), i = e.slice(r.commandIndex); if (r.match && r.pathIndex < t.segments.length) {
...
function Oe(t, n, e) { if (e.length === 0)
    ...
    let r = ji(e), i = Object.create(null);
    ...
    return Object.entries(r).forEach(([o, a]) => { typeof a == "string" && (a = [a]), a !== null && (i[o] = Zr(t.children[o], n, a)); }), Object.entries(t.children).forEach(([o, a]) => { r[o] === void 0 && (i[o] = a); }), new y(t.segments, i);
} }
function xi(t, n, e) { let r = 0, i = n, o = { match: !1, pathIndex: 0, commandIndex: 0 }; for (; i < t.segments.length;) {
    if (r >= e.length)
        return o;
...
function Ft(t, n, e) { let r = t.segments.slice(0, n), i = 0; for (; i < e.length;) {
    ...
    if (i === 0 && nt(e[0])) {
        let s = t.segments[n];
        r.push(new ne(s.path, Ir(e[0]))), i++;
        continue;
    }
    let a = ke(o) ? o.outlets[f] : `${o}`, c = i < e.length - 1 ? e[i + 1] : null;
    a && c && nt(c) ? (r.push(new ne(a, Ir(c))), i += 2) : (r.push(new ne(a, {})), i++);
} return new y(r, {}); }
function ki(t) { let n = {}; return Object.entries(t).forEach(([e, r]) => { typeof r == "string" && (r = [r]), r !== null && (n[e] = Ft(new y([], {}), 0, r)); }), n; }
...
function $i(t) { return !(t instanceof de) && !(t instanceof Ie) && !(t instanceof be); }
var gt = class {
    rootInjector;
    outlet = null;
    route = null;
...
function Jr(t, n) { let e = zi(t, n), r = new F([new ne("", {})]), i = new F({}), o = new F({}), a = new F({}), c = new F(""), s = new K(r, i, a, c, o, f, t, e.root); return s.snapshot = e.root, new ze(new j(s, []), e); }
function zi(t, n) { let e = {}, r = {}, i = {}, a = new Ae([], e, i, "", r, f, t, null, {}, n); return new He("", new j(a, [])); }
var K = class {
    urlSubject;
    paramsSubject;
    queryParamsSubject;
...
var Ae = class {
    ...
    toString() { return Xr(this._root); }
};
function ar(t, n) { n.value._routerState = t, n.children.forEach(e => ar(t, e)); }
function Xr(t) { let n = t.children.length > 0 ? ` { ${t.children.map(Xr).join(", ")} } ` : ""; return `${t.value}${n}`; }
function Pt(t) { if (t.snapshot) {
    let n = t.snapshot, e = t._futureSnapshot;
    t.snapshot = e, Q(n.queryParams, e.queryParams) || t.queryParamsSubject.next(e.queryParams), n.fragment !== e.fragment && t.fragmentSubject.next(e.fragment), Q(n.params, e.params) || t.paramsSubject.next(e.params), pi(n.url, e.url) || t.urlSubject.next(e.url), Q(n.data, e.data) || t.dataSubject.next(e.data);
}
else
    t.snapshot = t._futureSnapshot, t.dataSubject.next(t._futureSnapshot.data); }
function Vt(t, n) { let e = Q(t.params, n.params) && Ri(t.url, n.url), r = !t.parent != !n.parent; return e && !r && (!t.parent || Vt(t.parent, n.parent)); }
function en(t) { return typeof t.title == "string" || t.title === null; }
var tn = new ee(""), sr = (() => { class t {
    activated = null;
    ...
    get(n, e) { return n === K ? this.route : n === ge ? this.childContexts : n === tn ? this.outletData : this.parent.get(n, e); }
}, Ve = new ee(""), rn = (() => { class t {
    options;
    ...
    subscribeToRouteData(e) { let { activatedRoute: r } = e, i = _r([this.options.queryParams ? r.queryParams : m({}), r.params, r.data]).pipe(H(([o, a, c], s) => (c = l(l(l({}, o), a), c), s === 0 ? m(c) : Promise.resolve(c)))).subscribe(o => { if (!e.isActivated || !e.activatedComponentRef || e.activatedRoute !== r || r.component === null) {
        this.unsubscribeFromRouteData(e);
        return;
    } let a = Kn(r.component); if (!a) {
        this.unsubscribeFromRouteData(e);
        return;
...
function Fi(t, n, e) { let r = new Set, i = Fe(t, n._root, e ? e._root : void 0, r); return { newlyCreatedRoutes: r, state: new ze(i, n) }; }
...
function qi(t, n, e, r) { return n.children.map(i => { for (let o of e.children)
    if (t.shouldReuseRoute(i.value, o.value.snapshot))
        return Fe(t, i, o, r); return Fe(t, i, void 0, r); }); }
function Bi(t) { return new K(new F(t.url), new F(t.params), new F(t.queryParams), new F(t.fragment), new F(t.data), t.outlet, t.component, t); }
var Ee = class {
    redirectTo;
    navigationBehaviorOptions;
    constructor(n, e) { this.redirectTo = n, this.navigationBehaviorOptions = e; }
}, nn = "ngNavigationCancelingError";
function mt(t, n) { let { redirectTo: e, navigationBehaviorOptions: r } = ie(n) ? { redirectTo: n, navigationBehaviorOptions: void 0 } : n, i = on(!1, I.Redirect); return i.url = e, i.navigationBehaviorOptions = r, i; }
function on(t, n) { let e = new Error(`NavigationCancelingError: ${t || ""}`); return e[nn] = !0, e.cancellationCode = n, e; }
function Vi(t) { return an(t) && ie(t.url); }
function an(t) { return !!t && t[nn]; }
var Wt = class {
    routeReuseStrategy;
    futureState;
    currState;
...
function Gi(t, n, e) { let r = t._root, i = n ? n._root : null; return _e(r, i, e, [r.value]); }
function Wi(t) { let n = t.routeConfig ? t.routeConfig.canActivateChild : null; return !n || n.length === 0 ? null : { node: t, guards: n }; }
function Ne(t, n) { let e = Symbol(), r = n.get(t, e); return r === e ? typeof t == "function" && !Yn(t) ? t : n.get(t) : r; }
function _e(t, n, e, r, i = { canDeactivateChecks: [], canActivateChecks: [] }) { let o = me(n); return t.children.forEach(a => { Qi(a, o[a.value.outlet], e, r.concat([a.value]), i), delete o[a.value.outlet]; }), Object.entries(o).forEach(([a, c]) => Pe(c, e.getContext(a), i)), i; }
function Qi(t, n, e, r, i = { canDeactivateChecks: [], canActivateChecks: [] }) { let o = t.value, a = n ? n.value : null, c = e ? e.getContext(t.value.outlet) : null; if (a && o.routeConfig === a.routeConfig) {
    let s = Ki(a, o, o.routeConfig.runGuardsAndResolvers);
...
function Ki(t, n, e) { if (typeof e == "function")
...
function Yi(t) { return typeof t == "boolean"; }
function Zi(t) { return t && Ge(t.canLoad); }
function Ji(t) { return t && Ge(t.canActivate); }
function Xi(t) { return t && Ge(t.canActivateChild); }
function eo(t) { return t && Ge(t.canDeactivate); }
function to(t) { return t && Ge(t.canMatch); }
function sn(t) { return t instanceof ai || t?.name === "EmptyError"; }
var Je = Symbol("INITIAL_VALUE");
function Te() { return H(t => _r(t.map(n => n.pipe(Le(1), di(Je)))).pipe(U(n => { for (let e of n)
    if (e !== !0) {
        if (e === Je)
            return Je;
        if (e === !1 || ro(e))
...
function ro(t) { return ie(t) || t instanceof Ee; }
function cn(t) { return t.aborted ? m(void 0).pipe(Le(1)) : new si(n => { let e = () => { n.next(), n.complete(); }; return t.addEventListener("abort", e), () => t.removeEventListener("abort", e); }); }
function un(t) { return jt(cn(t)); }
function no(t) { return le(n => { let { targetSnapshot: e, currentSnapshot: r, guards: { canActivateChecks: i, canDeactivateChecks: o } } = n; return o.length === 0 && i.length === 0 ? m(N(l({}, n), { guardsResult: !0 })) : io(o, e, r).pipe(le(a => a && Yi(a) ? oo(e, i, t) : m(a)), U(a => N(l({}, n), { guardsResult: a }))); }); }
function io(t, n, e) { return W(t).pipe(le(r => lo(r.component, r.route, e, n)), fe(r => r !== !0, !0)); }
function oo(t, n, e) { return W(n).pipe(Ur(r => ci(so(r.route.parent, e), ao(r.route, e), uo(t, r.path), co(t, r.route))), fe(r => r !== !0, !0)); }
function ao(t, n) { return t !== null && n && n(new ft(t)), m(!0); }
function so(t, n) { return t !== null && n && n(new ht(t)), m(!0); }
function co(t, n) { let e = n.routeConfig ? n.routeConfig.canActivate : null; if (!e || e.length === 0)
    return m(!0); let r = e.map(i => tr(() => { let o = n._environmentInjector, a = Ne(i, o), c = Ji(a) ? a.canActivate(n, t) : $(o, () => a(n, t)); return pe(c).pipe(fe()); })); return m(r).pipe(Te()); }
function uo(t, n) { let e = n[n.length - 1], i = n.slice(0, n.length - 1).reverse().map(o => Wi(o)).filter(o => o !== null).map(o => tr(() => { let a = o.guards.map(c => { let s = o.node._environmentInjector, u = Ne(c, s), h = Xi(u) ? u.canActivateChild(e, t) : $(s, () => u(e, t)); return pe(h).pipe(fe()); }); return m(a).pipe(Te()); })); return m(i).pipe(Te()); }
function lo(t, n, e, r) { let i = n && n.routeConfig ? n.routeConfig.canDeactivate : null; if (!i || i.length === 0)
    return m(!0); let o = i.map(a => { let c = n._environmentInjector, s = Ne(a, c), u = eo(s) ? s.canDeactivate(t, n, e, r) : $(c, () => s(t, n, e, r)); return pe(u).pipe(fe()); }); return m(o).pipe(Te()); }
function ho(t, n, e, r, i) { let o = n.canLoad; if (o === void 0 || o.length === 0)
    return m(!0); let a = o.map(c => { let s = Ne(c, t), u = Zi(s) ? s.canLoad(n, e) : $(t, () => s(n, e)), h = pe(u); return i ? h.pipe(un(i)) : h; }); return m(a).pipe(Te(), ln(r)); }
function ln(t) { return ui(G(n => { if (typeof n != "boolean")
    throw mt(t, n); }), U(n => n === !0)); }
function fo(t, n, e, r, i, o) { let a = n.canMatch; if (!a || a.length === 0)
    return m(!0); let c = a.map(s => { let u = Ne(s, t), h = to(u) ? u.canMatch(n, e, i) : $(t, () => u(n, e, i)); return pe(h).pipe(un(o)); }); return m(c).pipe(Te(), ln(r)); }
...
function po(t) { throw new M(4e3, !1); }
function go(t) { throw on(!1, I.GuardRejected); }
var Qt = class {
    urlSerializer;
    urlTree;
    ...
    lineralizeSegments(n, e) { return S(this, null, function* () { let r = [], i = e.root; for (;;) {
        ...
        if (i.numberOfChildren > 1 || !i.children[f])
            throw po(`${n.redirectTo}`);
        i = i.children[f];
    } }); }
    applyRedirectCommands(n, e, r, i, o) { return S(this, null, function* () { let a = yield vo(e, i, o); if (a instanceof _)
...
function vo(t, n, e) { if (typeof t == "string")
    return Promise.resolve(t); let r = t; return rt(pe($(e, () => r(n)))); }
function mo(t, n) { return t.providers && !t._injector && (t._injector = Zn(t.providers, n, `Route: ${t.path}`)), t._injector ?? n; }
function q(t) { return t.outlet || f; }
function yo(t, n) { let e = t.filter(r => q(r) === n); return e.push(...t.filter(r => q(r) !== n)), e; }
...
function Ro(t, n, e, r, i, o, a) { let c = dn(t, n, e); if (!c.matched)
    return m(c); let s = hn(o(c)); return r = mo(n, r), fo(r, n, e, i, s, a).pipe(U(u => u === !0 ? c : l({}, Kt))); }
function dn(t, n, e) { if (n.path === "")
...
function Er(t, n, e, r, i) { return e.length > 0 && wo(t, e, r, i) ? { segmentGroup: new y(n, Co(r, new y(e, t.children))), slicedSegments: [] } : e.length === 0 && bo(t, e, r) ? { segmentGroup: new y(t.segments, So(t, e, r, t.children)), slicedSegments: e } : { segmentGroup: new y(t.segments, t.children), slicedSegments: e }; }
function So(t, n, e, r) { let i = {}; for (let o of e)
    if (St(t, n, o) && !r[q(o)]) {
        let a = new y([], {});
        i[q(o)] = a;
    } return l(l({}, r), i); }
function Co(t, n) { let e = {}; e[f] = n; for (let r of t)
    if (r.path === "" && q(r) !== f) {
        let i = new y([], {});
        e[q(r)] = i;
    } return e; }
function wo(t, n, e, r) { return e.some(i => !St(t, n, i) || !(q(i) !== f) ? !1 : !(r !== void 0 && q(i) === r)); }
function bo(t, n, e) { return e.some(r => St(t, n, r)); }
...
function Ao(t, n, e, r, i, o, a, c) { return S(this, null, function* () { return new Zt(t, n, e, r, i, a, o, c).recognize(); }); }
var Eo = 31, Zt = class {
    injector;
    configLoader;
    rootComponentType;
    ...
    recognize() { return S(this, null, function* () { let n = Er(this.urlTree.root, [], [], this.config).segmentGroup, { children: e, rootSnapshot: r } = yield this.match(n), i = new j(r, e), o = new He("", i), a = Wr(r, [], this.urlTree.queryParams, this.urlTree.fragment); return a.queryParams = this.urlTree.queryParams, o.url = this.urlSerializer.serialize(a), { state: o, tree: a }; }); }
    ...
    processChildren(n, e, r, i) { return S(this, null, function* () { let o = []; for (let s of Object.keys(r.children))
        ...
        let u = r.children[s], h = yo(e, s), v = yield this.processSegmentGroup(n, h, u, s, i);
        a.push(...v);
    } let c = fn(a); return To(c), c; }); }
    ...
    expandSegmentAgainstRouteUsingRedirect(n, e, r, i, o, a, c) { return S(this, null, function* () { let { matched: s, parameters: u, consumedSegments: h, positionalParamSegments: v, remainingSegments: p } = dn(e, i, o); if (!s)
        throw new Z(e); typeof i.redirectTo == "string" && i.redirectTo[0] === "/" && (this.absoluteRedirectCount++, this.absoluteRedirectCount > Eo && (this.allowRedirects = !1)); let A = this.createSnapshot(n, i, o, u, c); if (this.abortSignal.aborted)
        throw new Error(this.abortSignal.reason); let E = yield this.applyRedirects.applyRedirectCommands(h, i.redirectTo, v, hn(A), n), w = yield this.applyRedirects.lineralizeSegments(i, E); return this.processSegment(n, r, e, w.concat(p), a, !1, c); }); }
    createSnapshot(n, e, r, i, o) { let a = new Ae(r, i, Object.freeze(l({}, this.urlTree.queryParams)), this.urlTree.fragment, Mo(e), q(e), e.component ?? e._loadedComponent ?? null, e, Do(e), n), c = or(a, o, this.paramsInheritanceStrategy); return a.params = Object.freeze(c.params), a.data = Object.freeze(c.data), a; }
    matchSegmentAgainstRoute(n, e, r, i, o, a) { return S(this, null, function* () { if (this.abortSignal.aborted)
        throw new Error(this.abortSignal.reason); let c = Y => this.createSnapshot(n, r, Y.consumedSegments, Y.parameters, a), s = yield rt(Ro(e, r, i, n, this.urlSerializer, c, this.abortSignal)); if (r.path === "**" && (e.children = {}), !s?.matched)
        throw new Z(e); n = r._injector ?? n; let { routes: u } = yield this.getChildConfig(n, r, i), h = r._loadedInjector ?? n, { parameters: v, consumedSegments: p, remainingSegments: A } = s, E = this.createSnapshot(n, r, p, v, a), { segmentGroup: w, slicedSegments: T } = Er(e, p, A, u, o); if (T.length === 0 && w.hasChildren()) {
    ...
    getChildConfig(n, e, r) { return S(this, null, function* () { if (e.children)
        ...
        if (yield rt(ho(n, e, r, this.urlSerializer, this.abortSignal))) {
...
function To(t) { t.sort((n, e) => n.value.outlet === f ? -1 : e.value.outlet === f ? 1 : n.value.outlet.localeCompare(e.value.outlet)); }
function No(t) { let n = t.value.routeConfig; return n && n.path === ""; }
...
function Do(t) { return t.resolve || {}; }
function _o(t, n, e, r, i, o, a) { return le(c => S(null, null, function* () { let { state: s, tree: u } = yield Ao(t, n, e, r, c.extractedUrl, i, o, a); return N(l({}, c), { targetSnapshot: s, urlAfterRedirects: u }); })); }
function Uo(t) { return le(n => { let { targetSnapshot: e, guards: { canActivateChecks: r } } = n; if (!r.length)
    return m(n); let i = new Set(r.map(c => c.route)), o = new Set; for (let c of i)
    if (!o.has(c))
        for (let s of pn(c))
            o.add(s); let a = 0; return W(o).pipe(Ur(c => i.has(c) ? Oo(c, e, t) : (c.data = or(c, c.parent, t).resolve, m(void 0))), G(() => a++), Or(1), le(c => a === o.size ? m(n) : z)); }); }
function pn(t) { let n = t.children.map(e => pn(e)).flat(); return [t, ...n]; }
function Oo(t, n, e) { let r = t.routeConfig, i = t._resolve; return r?.title !== void 0 && !en(r) && (i[Be] = r.title), tr(() => (t.data = or(t, t.parent, e).resolve, Po(i, t, n).pipe(U(o => (t._resolvedData = o, t.data = l(l({}, t.data), o), null))))); }
function Po(t, n, e) { let r = kt(t); if (r.length === 0)
    return m({}); let i = {}; return W(r).pipe(le(o => Lo(t[o], n, e).pipe(fe(), G(a => { if (a instanceof Ee)
    throw mt(new J, a); i[o] = a; }))), Or(1), U(() => i), Pr(o => sn(o) ? z : li(o))); }
function Lo(t, n, e) { let r = n._environmentInjector, i = Ne(t, r), o = i.resolve ? i.resolve(n, e) : $(r, () => i(n, e)); return pe(o); }
function Tr(t) { return H(n => { let e = t(n); return e ? W(e).pipe(U(() => n)) : m(n); }); }
var lr = (() => { class t {
    ...
    static \u0275fac = function (r) { return new (r || t); };
    static \u0275prov = R.\u0275\u0275defineService({ token: t, factory: () => g(gn) });
} return t; })(), gn = (() => { class t extends lr {
    title;
    constructor(e) { super(), this.title = e; }
    updateTitle(e) { let r = this.buildTitle(e); r !== void 0 && this.title.setTitle(r); }
    static \u0275fac = function (r) { return new (r || t)(R.\u0275\u0275inject(Lr.Title)); };
    static \u0275prov = R.\u0275\u0275defineInjectable({ token: t, factory: t.\u0275fac, providedIn: "root" });
    ...
    loadComponent(e, r) { return S(this, null, function* () { if (this.componentLoaders.get(r))
        ...
        let o = yield kr($(e, () => r.loadComponent())), a = yield mn(Mr(o));
    ...
    loadChildren(e, r) { if (this.childrenLoaders.get(r))
        ...
        let o = yield vn(r, this.compiler, e, this.onLoadEndListener);
...
function vn(t, n, e, r) { return S(this, null, function* () { let i = yield kr($(e, () => t.loadChildren())), o = yield mn(Mr(i)), a; o instanceof Xn || Array.isArray(o) ? a = o : a = yield n.compileModuleAsync(o), r && r(t); let c, s, u = !1, h; return Array.isArray(a) ? (s = a, u = !0) : (c = a.create(e).injector, h = a, s = c.get(ve, [], { optional: !0, self: !0 }).flat()), { routes: s.map(ur), injector: c, factory: h }; }); }
function mn(t) { return S(this, null, function* () { return t; }); }
var wt = (() => { class t {
    static \u0275fac = function (r) { return new (r || t); };
    static \u0275prov = R.\u0275\u0275defineService({ token: t, factory: () => g(jo) });
} return t; })(), jo = (() => { class t {
...
function yn(t, n, e) { let r = t.get(dr), i = t.get(qn); if (!i.startViewTransition || r.skipNextTransition)
    return r.skipNextTransition = !1, new Promise(u => setTimeout(u)); let o, a = new Promise(u => { o = u; }), c = i.startViewTransition(() => (o(), xo(t))); c.updateCallbackDone.catch(u => { }), c.ready.catch(u => { }), c.finished.catch(u => { }); let { onViewTransitionCreated: s } = r; return s && $(t, () => s({ transition: c, from: n, to: e })), a; }
function xo(t) { return new Promise(n => { ei({ read: () => setTimeout(n) }, { injector: t }); }); }
var fr = new ee(""), ko = () => { }, bt = new ee(""), It = (() => { class t {
    ...
    paramsInheritanceStrategy = this.options.paramsInheritanceStrategy || Hi;
    ...
    setupNavigations(e) { return this.transitions = new F(null), this.transitions.pipe(je(r => r !== null), H(r => { let i = !0, o = !1, a = new AbortController, c = () => !o && this.currentTransition?.id === r.id; return m(r).pipe(H(s => { if (this.navigationId > r.id)
        ...
        return this.events.next(new B(s.id, this.urlSerializer.serialize(s.extractedUrl), "", Ce.IgnoredByUrlHandlingStrategy)), s.resolve(!1), z; }), U(s => { let u = new ot(s.id, this.urlSerializer.serialize(s.extractedUrl), this.urlSerializer.serialize(s.urlAfterRedirects), s.targetSnapshot); return this.events.next(u), this.currentTransition = r = N(l({}, s), { guards: Gi(s.targetSnapshot, s.currentSnapshot, this.rootContexts) }), r; }), no(s => this.events.next(s)), H(s => { if (r.guardsResult = s.guardsResult, s.guardsResult && typeof s.guardsResult != "boolean")
        ...
        return z; let v = !1; return m(s).pipe(Uo(this.paramsInheritanceStrategy), G({ next: () => { v = !0; let p = new ct(s.id, this.urlSerializer.serialize(s.extractedUrl), this.urlSerializer.serialize(s.urlAfterRedirects), s.targetSnapshot); this.events.next(p); }, complete: () => { v || this.cancelNavigationTransition(s, "", I.NoDataFromResolver); } })); }), Tr(s => { let u = v => { let p = []; if (v.routeConfig?._loadedComponent)
        ...
        p.push(...u(A)); return p; }, h = u(s.targetSnapshot.root); return h.length === 0 ? m(s) : W(Promise.all(h).then(() => s)); }), H(s => { let { newlyCreatedRoutes: u, state: h } = Fi(e.routeReuseStrategy, s.targetSnapshot, s.currentRouterState); return this.currentTransition = r = s = N(l({}, s), { targetRouterState: h, newlyCreatedRoutes: u }), this.currentNavigation.update(v => (v.targetRouterState = h, v)), m(s); }), this.activatedRouteInjectorFeature?.operator() ?? (s => s), Tr(() => this.afterPreactivation()), H(() => { let { currentSnapshot: s, targetSnapshot: u } = r, h = this.createViewTransition?.(this.environmentInjector, s.root, u.root); return h ? W(h).pipe(U(() => r)) : m(r); }), Le(1), H(s => { i = !1, this.events.next(new de); let u = r.beforeActivateHandler.deferredHandle; return u ? W(u.then(() => s)) : m(s); }), G(s => { new Wt(e.routeReuseStrategy, r.targetRouterState, r.currentRouterState, u => this.events.next(u), this.inputBindingEnabled).activate(this.rootContexts), s.newlyCreatedRoutes?.clear(), c() && (o = !0, this.currentNavigation.update(u => (u.abort = ko, u)), this.lastSuccessfulNavigation.set(Ue(this.currentNavigation)), this.events.next(new O(s.id, this.urlSerializer.serialize(s.extractedUrl), this.urlSerializer.serialize(s.urlAfterRedirects))), this.titleStrategy?.updateTitle(s.targetRouterState.snapshot), s.resolve(!0)); }), jt(cn(a.signal).pipe(je(() => !o && i), G(() => { this.cancelNavigationTransition(r, a.signal.reason + "", I.Aborted); }))), G({ complete: () => { o = !0; } }), jt(this.transitionAbortWithErrorSubject.pipe(G(s => { throw s; }))), fi(() => { a.abort(), o || this.cancelNavigationTransition(r, "", I.SupersededByNewNavigation), this.currentTransition?.id === r.id && (this.currentNavigation.set(null), this.currentTransition = null); }), Pr(s => { if (o = !0, Nr(r), this.destroyed)
        return r.resolve(!1), z; if (an(s))
        this.events.next(new D(r.id, this.urlSerializer.serialize(r.extractedUrl), s.message, s.cancellationCode)), Vi(s) ? this.events.next(new Ie(s.url, s.navigationBehaviorOptions)) : r.resolve(!1);
    else {
    ...
    cancelNavigationTransition(e, r, i) { Nr(e); let o = new D(e.id, this.urlSerializer.serialize(e.extractedUrl), r, i); this.events.next(o), e.resolve(!1); }
...
function $o(t) { return t !== Re; }
function Nr(t) { if (t.newlyCreatedRoutes)
    for (let n of t.newlyCreatedRoutes)
        n._localInjector?.destroy(); }
var pr = new ee("");
function Rn(t, n, e) { let r = new Set; n.snapshot.root && Sn(n.snapshot.root, r); let i = t.retrieveStoredRouteHandles?.() || []; for (let o of i) {
    let a = o;
    if (a?.route?.value?.snapshot)
        for (let c of a.route.value.snapshot.pathFromRoot)
            c.routeConfig && r.add(c.routeConfig);
} Jt(e, r, t, !1); }
function Sn(t, n) { t.routeConfig && n.add(t.routeConfig); for (let e of t.children)
    Sn(e, n); }
...
function zo(t) { let n = t; n && n.componentRef && (n.componentRef.destroy(), n.route.value._localInjector?.destroy()); }
var Cn = (() => { class t {
    static \u0275fac = function (r) { return new (r || t); };
    static \u0275prov = R.\u0275\u0275defineService({ token: t, factory: () => g(Ho) });
} return t; })(), Rt = class {
    ...
    static \u0275fac = function (r) { return new (r || t); };
    static \u0275prov = R.\u0275\u0275defineService({ token: t, factory: () => g(Fo) });
} return t; })(), Fo = (() => { class t extends Me {
    currentPageId = 0;
    lastSuccessfulId = -1;
...
var V = (() => { class t {
    ...
    subscribeToNavigationEvents() { let e = this.navigationTransitions.events.subscribe(r => { try {
        ...
        if (i !== null && o !== null) {
            if (this.stateManager.handleRouterEvent(r, o), r instanceof D && r.code !== I.Redirect && r.code !== I.SupersededByNewNavigation)
                ...
                let a = r.navigationBehaviorOptions, c = this.urlHandlingStrategy.merge(r.url, i.currentRawUrl), s = l({ scroll: i.extras.scroll, browserUrl: i.extras.browserUrl, info: i.extras.info, skipLocationChange: i.extras.skipLocationChange, replaceUrl: i.extras.replaceUrl || this.urlUpdateStrategy === "eager" || $o(i.source) }, a);
                this.scheduleNavigation(c, Re, null, s, { resolve: i.resolve, reject: i.reject, promise: i.promise });
            }
        }
        $i(r) && this._events.next(r);
    }
    catch (i) {
    ...
    } let s = this.parseUrl(c); this.scheduleNavigation(s, r, a, o).catch(u => { this.disposed || this.injector.get(ii)(u); }); }
    ...
    } return Kr(v, e, h, u ?? null, this.urlSerializer); }
    ...
    navigate(e, r = { skipLocationChange: !1 }) { return qo(e), this.navigateByUrl(this.createUrlTree(e, r), r); }
    serializeUrl(e) { return this.urlSerializer.serialize(e); }
    parseUrl(e) { try {
        return this.urlSerializer.parse(e);
    }
    catch {
        return this.console.warn(oi(4018, !1)), this.urlSerializer.parse("/");
    } }
...
function qo(t) { for (let n = 0; n < t.length; n++)
    if (t[n] == null)
        throw new M(4008, !1); }
import * as bn from "@angular/common";
import { ViewportScroller as In, PlatformNavigation as Bo, PlatformLocation as Vo, \u0275PRECOMMIT_HANDLER_SUPPORTED as Go, Location as Tt, LOCATION_INITIALIZED as Wo, \u0275NavigationAdapterForLocation as Qo, HashLocationStrategy as An, LocationStrategy as yr, PathLocationStrategy as Ko } from "@angular/common";
import * as d from "@angular/core";
import { inject as C, HostAttributeToken as Yo, linkedSignal as Zo, untracked as P, signal as L, input as Jo, \u0275INTERNAL_APPLICATION_ERROR_HANDLER as Xo, \u0275RuntimeError as os, computed as ea, booleanAttribute as gr, EventEmitter as ta, createEnvironmentInjector as En, InjectionToken as Qe, \u0275IS_HYDRATION_DOM_REUSE_ENABLED as ra, NgZone as na, ApplicationRef as Tn, EnvironmentInjector as ia, DestroyRef as oa, afterNextRender as aa, \u0275promiseWithResolvers as wn, makeEnvironmentProviders as sa, APP_BOOTSTRAP_LISTENER as Nn, provideAppInitializer as Mn, \u0275IS_ENABLED_BLOCKING_INITIAL_NAVIGATION as ca, Injector as Dn, \u0275performanceMarkFeature as ua } from "@angular/core";
import { Subject as Rr, of as se, from as Et } from "rxjs";
import { mergeAll as Nt, catchError as la, filter as ha, concatMap as da, mergeMap as fa, tap as pa } from "rxjs/operators";
var ga = (() => { class t {
    router = C(V);
    stateManager = C(Me);
    fragment = L("");
    ...
    el;
    locationStrategy;
    hrefAttributeValue = C(new Yo("href"), { optional: !0 });
    reactiveHref = Zo(() => this.isAnchorElement ? this.computeHref(this._urlTree()) : this.hrefAttributeValue);
    ...
    _replaceUrl = L(!1);
    browserUrl = Jo(void 0);
    isAnchorElement;
    onChanges = new Rr;
    applicationErrorHandler = C(Xo);
    options = C(te, { optional: !0 });
    reactiveRouterState = C(ga);
    ...
    static \u0275fac = function (r) { return new (r || t)(d.\u0275\u0275directiveInject(V), d.\u0275\u0275directiveInject(K), d.\u0275\u0275injectAttribute("tabindex"), d.\u0275\u0275directiveInject(d.Renderer2), d.\u0275\u0275directiveInject(d.ElementRef), d.\u0275\u0275directiveInject(bn.LocationStrategy)); };
    ...
    isLinkActive(e) { let r = ma(this.routerLinkActiveOptions) ? this.routerLinkActiveOptions : this.routerLinkActiveOptions.exact ?? !1 ? l({}, rr) : l({}, xe); return i => { let o = i.urlTree; return o ? P(nr(o, e, r)) : !1; }; }
...
function ma(t) { let n = t; return !!(n.paths || n.matrixParams || n.queryParams || n.fragment); }
var We = class {
}, ya = (() => { class t {
    preload(e, r) { return r().pipe(la(() => se(null))); }
    static \u0275fac = function (r) { return new (r || t); };
    static \u0275prov = d.\u0275\u0275defineService({ token: t, factory: t.\u0275fac });
} return t; })(), Ra = (() => { class t {
    ...
    setUpPreloading() { this.subscription = this.router.events.pipe(ha(e => e instanceof O), da(() => this.preload())).subscribe(() => { }); }
    preload() { return this.processRoutes(this.injector, this.router.config); }
    ngOnDestroy() { this.subscription?.unsubscribe(); }
    processRoutes(e, r) { let i = []; for (let o of r) {
        o.providers && !o._injector && (o._injector = En(o.providers, e, ""));
        let a = o._injector ?? e;
    ...
    preloadConfig(e, r) { return this.preloadingStrategy.preload(r, () => { if (e.destroyed)
        return se(null); let i; r.loadChildren && r.canLoad === void 0 ? i = Et(this.loader.loadChildren(e, r)) : i = se(null); let o = i.pipe(fa(a => a === null ? se(void 0) : (r._loadedRoutes = a.routes, r._loadedInjector = a.injector, r._loadedNgModuleFactory = a.factory, this.processRoutes(a.injector ?? e, a.routes)))); if (r.loadComponent && !r._loadedComponent) {
    ...
    restoredId = 0;
    store = {};
    isHydrating = C(ra, { optional: !0 }) ?? !1;
    urlSerializer = C(ae);
    zone = C(na);
    viewportScroller = C(In);
    transitions = C(It);
    constructor(e) { this.options = e, this.options.scrollPositionRestoration ||= "disabled", this.options.anchorScrolling ||= "disabled", this.isHydrating && C(Tn).whenStable().then(() => { this.isHydrating = !1; }); }
...
var Sa = (() => { class t extends Me {
    ...
    constructor() { super(); let e = r => { this.handleNavigate(r); }; this.navigation.addEventListener("navigate", e), C(oa).onDestroy(() => this.navigation.removeEventListener("navigate", e)); }
    ...
    handleRouterEvent(e, r) { return S(this, null, function* () { if (this.currentNavigation = N(l({}, this.currentNavigation), { routerTransition: r }), e instanceof X)
        ...
        this.currentNavigation = {}, o?.(), this.activeHistoryEntry = this.navigation.currentEntry, aa({ read: () => i?.() }, { injector: this.injector });
    } }); }
...
function Ca() { return pa(({ newlyCreatedRoutes: t, targetRouterState: n }) => { if (!t || !n)
    return; let e = r => { let i = r.value; i && wa(i, t); for (let o of r.children)
    e(o); }; e(n._root); }); }
function wa(t, n) { t?.routeConfig?.\u0275UseActivatedRouteInjector && n.has(t) && ba(t._futureSnapshot, t); }
function ba(t, n) { n._localInjector = En([], t._environmentInjector); }
function Ia(t, ...n) { return sa([{ provide: ve, multi: !0, useValue: t }, { provide: K, useFactory: On }, { provide: Nn, multi: !0, useFactory: Pn }, n.map(e => e.\u0275providers)]); }
function On() { return C(V).routerState.root; }
function k(t, n) { return { \u0275kind: t, \u0275providers: n }; }
function Aa(t = {}) { return k(4, [{ provide: Dt, useFactory: () => new Un(t) }]); }
function Ea() { return k(11, [{ provide: Me, useExisting: Sa }, { provide: Tt, useClass: Qo }, []]); }
function Pn() { let t = C(Dn); return n => { let e = t.get(Tn); if (n !== e.components[0])
    return; let r = t.get(V), i = t.get(Ln); t.get(Sr) === 1 && r.initialNavigation(), t.get(kn, null, { optional: !0 })?.setUpPreloading(), t.get(Dt, null, { optional: !0 })?.init(), r.resetRootComponentType(e.componentTypes[0]), i.closed || (i.next(), i.complete(), i.unsubscribe()); }; }
var Ln = new Qe("", { factory: () => new Rr }), Sr = new Qe("", { factory: () => 1 });
function jn() { let t = [{ provide: ca, useValue: !0 }, { provide: Sr, useValue: 0 }, Mn(() => { let n = C(Dn); return n.get(Wo, Promise.resolve()).then(() => new Promise(r => { let i = n.get(V), o = n.get(Ln); At(i, () => { r(!0); }), n.get(It).afterPreactivation = () => (r(!0), o.closed ? se(void 0) : o), i.initialNavigation(); })); })]; return k(2, t); }
function xn() { let t = [Mn(() => { C(V).setUpLocationChangeListener(); }), { provide: Sr, useValue: 2 }]; return k(3, t); }
function Ta() { let t = []; return t = [], k(1, t); }
var kn = new Qe("");
function $n(t) { return k(0, [{ provide: kn, useExisting: _n }, { provide: We, useExisting: t }]); }
function Na(t) { return k(5, [{ provide: te, useValue: t }]); }
function Ma() { return k(6, [{ provide: yr, useClass: An }]); }
function Da(t) { return k(7, [{ provide: bt, useValue: t }]); }
function _a() { return k(10, [{ provide: pr, useValue: Rn }]); }
function zn(t = {}) { return k(8, [{ provide: Ve, useFactory: () => new rn(t) }]); }
function Hn(t) { ua("NgRouterViewTransitions"); let n = [{ provide: hr, useValue: yn }, { provide: dr, useValue: l({ skipNextTransition: !!t?.skipInitialTransition }, t) }]; return k(9, n); }
function Ua() { return k(9, [{ provide: fr, useValue: { operator: Ca } }]); }
var Fn = [Tt, { provide: ae, useClass: J }, V, ge, { provide: K, useFactory: On }, Ct], Oa = (() => { class t {
    constructor() { }
    static forRoot(e, r) { return { ngModule: t, providers: [Fn, [], { provide: ve, multi: !0, useValue: e }, [], r?.errorHandler ? { provide: bt, useValue: r.errorHandler } : [], { provide: te, useValue: r || {} }, r?.useHash ? La() : ja(), Pa(), r?.preloadingStrategy ? $n(r.preloadingStrategy).\u0275providers : [], r?.initialNavigation ? xa(r) : [], r?.bindToComponentInputs ? zn(typeof r.bindToComponentInputs == "object" ? r.bindToComponentInputs : {}).\u0275providers : [], r?.enableViewTransitions ? Hn().\u0275providers : [], ka()] }; }
...
function Pa() { return { provide: Dt, useFactory: () => { let t = C(In), n = C(te); return n.scrollOffset && t.setOffset(n.scrollOffset), new Un(n); } }; }
function La() { return { provide: yr, useClass: An }; }
function ja() { return { provide: yr, useClass: Ko }; }
function xa(t) { return [t.initialNavigation === "disabled" ? xn().\u0275providers : [], t.initialNavigation === "enabledBlocking" ? jn().\u0275providers : []]; }
var mr = new Qe("");
function ka() { return [{ provide: mr, useFactory: Pn }, { provide: Nn, multi: !0, useExisting: mr }]; }
import { inject as Ke, Version as $a } from "@angular/core";
import "@angular/common";
import "rxjs";
import "rxjs/operators";
import "@angular/platform-browser";
function Ms(t) { return t.map(n => (...e) => Ke(n).canMatch(...e)); }
function Ds(t) { return t.map(n => (...e) => Ke(n).canActivate(...e)); }
function _s(t) { return t.map(n => (...e) => Ke(n).canActivateChild(...e)); }
function Us(t) { return t.map(n => (...e) => Ke(n).canDeactivate(...e)); }
function Os(t) { return (...n) => Ke(t).resolve(...n); }
var Ps = new $a("22.0.7");
export { K as ActivatedRoute, Ae as ActivatedRouteSnapshot, pt as ActivationEnd, ft as ActivationStart, Rt as BaseRouteReuseStrategy, dt as ChildActivationEnd, ht as ChildActivationStart, ge as ChildrenOutletContexts, gn as DefaultTitleStrategy, J as DefaultUrlSerializer, b as EventType, at as GuardsCheckEnd, ot as GuardsCheckStart, D as NavigationCancel, I as NavigationCancellationCode, O as NavigationEnd, oe as NavigationError, B as NavigationSkipped, Ce as NavigationSkippedCode, X as NavigationStart, Ra as NoPreloading, gt as OutletContext, f as PRIMARY_OUTLET, ya as PreloadAllModules, We as PreloadingStrategy, te as ROUTER_CONFIGURATION, mr as ROUTER_INITIALIZER, tn as ROUTER_OUTLET_DATA, ve as ROUTES, Ee as RedirectCommand, ct as ResolveEnd, st as ResolveStart, lt as RouteConfigLoadEnd, ut as RouteConfigLoadStart, Cn as RouteReuseStrategy, V as Router, x as RouterEvent, Mt as RouterLink, va as RouterLinkActive, Mt as RouterLinkWithHref, Oa as RouterModule, sr as RouterOutlet, _n as RouterPreloader, ze as RouterState, He as RouterStateSnapshot, $e as RoutesRecognized, we as Scroll, lr as TitleStrategy, wt as UrlHandlingStrategy, ne as UrlSegment, y as UrlSegmentGroup, ae as UrlSerializer, _ as UrlTree, Ps as VERSION, he as convertToParamMap, Wr as createUrlTreeFromSnapshot, jr as defaultUrlMatcher, zo as destroyDetachedRouteHandle, nr as isActive, Ds as mapToCanActivate, _s as mapToCanActivateChild, Us as mapToCanDeactivate, Ms as mapToCanMatch, Os as mapToResolve, Ia as provideRouter, zn as withComponentInputBinding, Ta as withDebugTracing, xn as withDisabledInitialNavigation, jn as withEnabledBlockingInitialNavigation, _a as withExperimentalAutoCleanupInjectors, Ea as withExperimentalPlatformNavigation, Ma as withHashLocation, Aa as withInMemoryScrolling, Da as withNavigationErrorHandler, $n as withPreloading, Na as withRouterConfig, Hn as withViewTransitions, cr as \u0275EmptyOutletComponent, Fn as \u0275ROUTER_PROVIDERS, At as \u0275afterNextNavigation, vn as \u0275loadChildren, Ua as \u0275withActivatedRouteInjectors };

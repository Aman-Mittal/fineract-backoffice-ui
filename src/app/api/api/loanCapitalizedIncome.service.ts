...
// @ts-ignore
import { CapitalizedIncomeDetails } from '../model/capitalizedIncomeDetails';
// @ts-ignore
import { LoanAmortizationAllocationResponse } from '../model/loanAmortizationAllocationResponse';
// @ts-ignore
import { LoanCapitalizedIncomeData } from '../model/loanCapitalizedIncomeData';
...
export class LoanCapitalizedIncomeService extends BaseService {
    ...
    public fetchCapitalizedIncomeDetailsByExternalId(loanExternalId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/v1/loans/external-id/${this.configuration.encodeParam({name: "loanExternalId", value: loanExternalId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/capitalized-incomes`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<CapitalizedIncomeDetails>>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
    ...
    public getCapitalizedIncomeAllocationDataByExternalIds(loanExternalId: string, loanTransactionExternalId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/v1/loans/external-id/${this.configuration.encodeParam({name: "loanExternalId", value: loanExternalId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}/capitalized-incomes/external-id/${this.configuration.encodeParam({name: "loanTransactionExternalId", value: loanTransactionExternalId, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: undefined})}`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @endpoint get /v1/loans/external-id/{loanExternalId}/capitalized-incomes/{loanTransactionId}
     * @param loanExternalId loanExternalId
     ...
     * @endpoint get /v1/loans/{loanId}/capitalized-incomes/{loanTransactionId}
     * @param loanId loanId
     * @param loanTransactionId loanTransactionId
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.

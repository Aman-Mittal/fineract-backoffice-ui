...
import { SavingsProductService, PostSavingsProductsRequest, PutSavingsProductsProductIdRequest } from '../../api';
  ...
  template: `
    <div class="form-container">
      <mat-card>
        <mat-card-header>
          <mat-card-title>
            {{ isEditMode ? ('PRODUCTS.EDIT_SAVINGS_PRODUCT' | translate) : ('PRODUCTS.CREATE_SAVINGS_PRODUCT' | translate) }}
          </mat-card-title>
        </mat-card-header>
          ...
          <form #productForm="ngForm" (ngSubmit)="onSubmit()" class="product-form">
            <div class="form-grid">
              ...
              <mat-form-field appearance="outline" [matTooltip]="'HELP.INTEREST_RATE_DESC' | translate">
                ...
                <input matInput type="number" name="nominalAnnualInterestRate" [(ngModel)]="product.nominalAnnualInterestRate" required>
              </mat-form-field>
            </div>
...
export class SavingsProductFormComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.isEditMode && this.productId) {
      this.productService.update22(this.productId, this.product as PutSavingsProductsProductIdRequest).subscribe({

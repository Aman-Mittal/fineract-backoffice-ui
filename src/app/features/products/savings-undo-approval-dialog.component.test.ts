...
import { SavingsUndoApprovalDialogComponent } from './savings-undo-approval-dialog.component';
import { provideFakeAdapters, FakeOverlayAdapter } from '../../testing/adapters';

describe('SavingsUndoApprovalDialogComponent', () => {
  let fixture: ComponentFixture<SavingsUndoApprovalDialogComponent>;
  let component: SavingsUndoApprovalDialogComponent;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [SavingsUndoApprovalDialogComponent],
      providers: [provideNoopAnimations(), ...adapters.providers],
    }).compileComponents();

    fixture = TestBed.createComponent(SavingsUndoApprovalDialogComponent);
  ...
  it('trims the reason and sends it as `note`', () => {
    component.note.set('  approved amount was wrong  ');

    component.onConfirm();

    expect(overlay.dismissals).toEqual([{ note: 'approved amount was wrong' }]);
  });

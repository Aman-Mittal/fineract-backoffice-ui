import { c as P } from "@nf-internal/chunk-UEP2XE3O";
import { a as x, d as B } from "@nf-internal/chunk-YK4F7Q7H";
import { b as O } from "@nf-internal/chunk-PJKO2XHO";
import { b as R, f as k, g as F, h as C, k as A } from "@nf-internal/chunk-ZNX7NM6F";
import { c as S } from "@nf-internal/chunk-EETP6BN4";
import { a as h, e as _, f as q } from "@nf-internal/chunk-NG3GO5GG";
import { a as E } from "@nf-internal/chunk-55MUSWHY";
...
var b = '[tabindex]:not([tabindex^="-"]):not([hidden]):not([disabled]), input:not([type=hidden]):not([tabindex^="-"]):not([hidden]):not([disabled]), textarea:not([tabindex^="-"]):not([hidden]):not([disabled]), button:not([tabindex^="-"]):not([hidden]):not([disabled]), select:not([tabindex^="-"]):not([hidden]):not([disabled]), ion-checkbox:not([tabindex^="-"]):not([hidden]):not([disabled]), ion-radio:not([tabindex^="-"]):not([hidden]):not([disabled]), .ion-focusable:not([tabindex^="-"]):not([hidden]):not([disabled]), .ion-focusable[disabled="false"]:not([tabindex^="-"]):not([hidden])', N = (e, n) => { let t = e.querySelector(b); G(t, n ?? e); }, V = (e, n) => { let t = Array.from(e.querySelectorAll(b)), o = t.length > 0 ? t[t.length - 1] : null; G(o, n ?? e); }, G = (e, n) => { let t = e, o = e?.shadowRoot; if (o && (t = o.querySelector(b) || e), t) {
    ...
    l && l.contains(i) || M(!0), document.body.classList.add(E);
} (r = e.willPresentShorthand) === null || r === void 0 || r.emit(); let u = S(e), m = e.enterAnimation ? e.enterAnimation : h.get(n, u === "ios" ? t : o); if ((yield U(e, m, e.el, s)) && (e.didPresent.emit(), (a = e.didPresentShorthand) === null || a === void 0 || a.emit()), e.keyboardClose && (document.activeElement === null || !e.el.contains(document.activeElement))) {
    let v = C(e.el).querySelector('[role="dialog"][tabindex]'), l = v ?? e.el;
    try {
    ...
    return !1; let u = (O !== void 0 ? W(O) : []).filter(l => { let f = l; return f.tagName !== "ION-TOAST" && f.focusTrap !== !1 && T(f); }), m = e.el; m.tagName !== "ION-TOAST" && m.focusTrap !== !1 && T(m) && u.length === 1 && u[0].id === m.id && (M(!1), document.body.classList.remove(E)), e.presented = !1; try {
    ...
    let l = S(e), f = e.leaveAnimation ? e.leaveAnimation : h.get(o, l === "ios" ? s : r);
...
@ionic/core/dist/esm/overlays-COCl_nm9.js:
  (*!

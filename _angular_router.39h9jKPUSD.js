...
import { first as fe, map as U, switchMap as H, take as je, startWith as di, filter as xe, takeUntil as jt, mergeMap as le, concatMap as Ur, tap as G, takeLast as Or, catchError as Pr, finalize as fi } from "rxjs/operators";
...
var vi = { exact: zr, subset: Hr }, $r = { exact: mi, subset: yi, ignored: () => !0 }, rr = { paths: "exact", fragment: "ignored", matrixParams: "ignored", queryParams: "exact" }, Ce = { paths: "subset", fragment: "ignored", matrixParams: "ignored", queryParams: "subset" };
function nr(t, n, e) { let r = t instanceof _ ? t : n.parseUrl(t); return Vn(() => $t(n.lastSuccessfulNavigation()?.finalUrl ?? new _, r, l(l({}, Ce), e))); }
...
var ae = (() => { class t {
    ...
    serialize(n) { let e = `/${_e(n.root, !0)}`, r = Ii(n.queryParams), i = typeof n.fragment == "string" ? `#${wi(n.fragment)}` : ""; return `${e}${r}${i}`; }
}, Ci = new J;
...
function _e(t, n) { if (!t.hasChildren())
    ...
    let e = Si(t, (r, i) => i === f ? [_e(t.children[f], !1)] : [`${i}:${_e(r, !1)}`]);
...
function Kr(t, n, e, r, i) { let o = t; for (; o.parent;)
    ...
    return Ot(o, o, new y([], {}), e, r, i); let c = Pi(a, o, t), s = c.processChildren ? Pe(c.segmentGroup, c.index, a.commands) : Zr(c.segmentGroup, c.index, a.commands); return Ot(o, c.segmentGroup, s, e, r, i); }
...
function $i(t) { return !(t instanceof de) && !(t instanceof Ae) && !(t instanceof Ie); }
var gt = class {
    rootInjector;
    outlet = null;
    route = null;
...
function zi(t, n) { let e = {}, r = {}, i = {}, a = new Ee([], e, i, "", r, f, t, null, {}, n); return new He("", new j(a, [])); }
var K = class {
    urlSubject;
    paramsSubject;
    queryParamsSubject;
...
function Gi(t, n, e) { let r = t._root, i = n ? n._root : null; return Ue(r, i, e, [r.value]); }
function Wi(t) { let n = t.routeConfig ? t.routeConfig.canActivateChild : null; return !n || n.length === 0 ? null : { node: t, guards: n }; }
function Me(t, n) { let e = Symbol(), r = n.get(t, e); return r === e ? typeof t == "function" && !Yn(t) ? t : n.get(t) : r; }
function Ue(t, n, e, r, i = { canDeactivateChecks: [], canActivateChecks: [] }) { let o = me(n); return t.children.forEach(a => { Qi(a, o[a.value.outlet], e, r.concat([a.value]), i), delete o[a.value.outlet]; }), Object.entries(o).forEach(([a, c]) => Le(c, e.getContext(a), i)), i; }
...
function Ne() { return H(t => _r(t.map(n => n.pipe(je(1), di(Je)))).pipe(U(n => { for (let e of n)
    if (e !== !0) {
        if (e === Je)
            return Je;
        if (e === !1 || ro(e))
...
function ro(t) { return ie(t) || t instanceof Te; }
function cn(t) { return t.aborted ? m(void 0).pipe(je(1)) : new si(n => { let e = () => { n.next(), n.complete(); }; return t.addEventListener("abort", e), () => t.removeEventListener("abort", e); }); }
...
function co(t, n) { let e = n.routeConfig ? n.routeConfig.canActivate : null; if (!e || e.length === 0)
    return m(!0); let r = e.map(i => tr(() => { let o = n._environmentInjector, a = Me(i, o), c = Ji(a) ? a.canActivate(n, t) : $(o, () => a(n, t)); return pe(c).pipe(fe()); })); return m(r).pipe(Ne()); }
function uo(t, n) { let e = n[n.length - 1], i = n.slice(0, n.length - 1).reverse().map(o => Wi(o)).filter(o => o !== null).map(o => tr(() => { let a = o.guards.map(c => { let s = o.node._environmentInjector, u = Me(c, s), h = Xi(u) ? u.canActivateChild(e, t) : $(s, () => u(e, t)); return pe(h).pipe(fe()); }); return m(a).pipe(Ne()); })); return m(i).pipe(Ne()); }
function lo(t, n, e, r) { let i = n && n.routeConfig ? n.routeConfig.canDeactivate : null; if (!i || i.length === 0)
    return m(!0); let o = i.map(a => { let c = n._environmentInjector, s = Me(a, c), u = eo(s) ? s.canDeactivate(t, n, e, r) : $(c, () => s(t, n, e, r)); return pe(u).pipe(fe()); }); return m(o).pipe(Ne()); }
function ho(t, n, e, r, i) { let o = n.canLoad; if (o === void 0 || o.length === 0)
    return m(!0); let a = o.map(c => { let s = Me(c, t), u = Zi(s) ? s.canLoad(n, e) : $(t, () => s(n, e)), h = pe(u); return i ? h.pipe(un(i)) : h; }); return m(a).pipe(Ne(), ln(r)); }
...
function fo(t, n, e, r, i, o) { let a = n.canMatch; if (!a || a.length === 0)
    return m(!0); let c = a.map(s => { let u = Me(s, t), h = to(u) ? u.canMatch(n, e, i) : $(t, () => u(n, e, i)); return pe(h).pipe(un(o)); }); return m(c).pipe(Ne(), ln(r)); }
...
var Eo = 31, Zt = class {
    ...
    createSnapshot(n, e, r, i, o) { let a = new Ee(r, i, Object.freeze(l({}, this.urlTree.queryParams)), this.urlTree.fragment, Mo(e), q(e), e.component ?? e._loadedComponent ?? null, e, Do(e), n), c = or(a, o, this.paramsInheritanceStrategy); return a.params = Object.freeze(c.params), a.data = Object.freeze(c.data), a; }
...
function Po(t, n, e) { let r = kt(t); if (r.length === 0)
    return m({}); let i = {}; return W(r).pipe(le(o => Lo(t[o], n, e).pipe(fe(), G(a => { if (a instanceof Te)
    throw mt(new J, a); i[o] = a; }))), Or(1), U(() => i), Pr(o => sn(o) ? z : li(o))); }
function Lo(t, n, e) { let r = n._environmentInjector, i = Me(t, r), o = i.resolve ? i.resolve(n, e) : $(r, () => i(n, e)); return pe(o); }
...
var fr = new ee(""), ko = () => { }, bt = new ee(""), It = (() => { class t {
    ...
    setupNavigations(e) { return this.transitions = new F(null), this.transitions.pipe(xe(r => r !== null), H(r => { let i = !0, o = !1, a = new AbortController, c = () => !o && this.currentTransition?.id === r.id; return m(r).pipe(H(s => { if (this.navigationId > r.id)
        ...
        p.push(...u(A)); return p; }, h = u(s.targetSnapshot.root); return h.length === 0 ? m(s) : W(Promise.all(h).then(() => s)); }), H(s => { let { newlyCreatedRoutes: u, state: h } = Fi(e.routeReuseStrategy, s.targetSnapshot, s.currentRouterState); return this.currentTransition = r = s = N(l({}, s), { targetRouterState: h, newlyCreatedRoutes: u }), this.currentNavigation.update(v => (v.targetRouterState = h, v)), m(s); }), this.activatedRouteInjectorFeature?.operator() ?? (s => s), Tr(() => this.afterPreactivation()), H(() => { let { currentSnapshot: s, targetSnapshot: u } = r, h = this.createViewTransition?.(this.environmentInjector, s.root, u.root); return h ? W(h).pipe(U(() => r)) : m(r); }), je(1), H(s => { i = !1, this.events.next(new de); let u = r.beforeActivateHandler.deferredHandle; return u ? W(u.then(() => s)) : m(s); }), G(s => { new Wt(e.routeReuseStrategy, r.targetRouterState, r.currentRouterState, u => this.events.next(u), this.inputBindingEnabled).activate(this.rootContexts), s.newlyCreatedRoutes?.clear(), c() && (o = !0, this.currentNavigation.update(u => (u.abort = ko, u)), this.lastSuccessfulNavigation.set(Oe(this.currentNavigation)), this.events.next(new O(s.id, this.urlSerializer.serialize(s.extractedUrl), this.urlSerializer.serialize(s.urlAfterRedirects))), this.titleStrategy?.updateTitle(s.targetRouterState.snapshot), s.resolve(!0)); }), jt(cn(a.signal).pipe(xe(() => !o && i), G(() => { this.cancelNavigationTransition(r, a.signal.reason + "", I.Aborted); }))), G({ complete: () => { o = !0; } }), jt(this.transitionAbortWithErrorSubject.pipe(G(s => { throw s; }))), fi(() => { a.abort(), o || this.cancelNavigationTransition(r, "", I.SupersededByNewNavigation), this.currentTransition?.id === r.id && (this.currentNavigation.set(null), this.currentTransition = null); }), Pr(s => { if (o = !0, Nr(r), this.destroyed)
        return r.resolve(!1), z; if (an(s))
        this.events.next(new D(r.id, this.urlSerializer.serialize(r.extractedUrl), s.message, s.cancellationCode)), Vi(s) ? this.events.next(new Ae(s.url, s.navigationBehaviorOptions)) : r.resolve(!1);
    else {
...
} return t; })(), Fo = (() => { class t extends De {
    currentPageId = 0;
    lastSuccessfulId = -1;
...
var ga = (() => { class t {
    ...
    isLinkActive(e) { let r = this.routerLinkActiveOptions; if (r === null)
        return () => !1; let i; return r === void 0 ? i = l({}, Ce) : ma(r) ? i = r : r.exact ?? !1 ? i = l({}, rr) : i = l({}, Ce), o => { let a = o.urlTree; return a ? P(nr(a, e, i)) : !1; }; }
...
function Ea() { return k(11, [{ provide: De, useExisting: Sa }, { provide: Tt, useClass: Qo }, []]); }
